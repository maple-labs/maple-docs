...
$$ \Huge \frac{collateral}{outstandingPrincipal} \ge \frac{collateralRequired}{principalRequired} $$
...
$$ \Huge collateral \ge \frac{collateralRequired \times outstandingPrincipal}{principalRequired} $$
...
$$ \Huge periodicRate     = \frac{interestRate \times paymentInterval}{365 \times 24 \times 60 \times 60} $$
$$ \Huge raisedRate       = (1 + periodicRate)^{paymentsRemaining} $$
$$ \Huge total            = \frac{(principal \times raisedRate - endingPrincipal) \ periodicRate}{raisedRate - 1} $$
$$ \Huge interestPortion  = principal \times periodicRate $$
$$ \Huge principalPortion = total - interestPortion $$
...
$$ totalLatePayment = total + (principal \times lateFeeRate) + \frac{principal \times (interestRate + lateInterestPremium) \times daysLate \times 86400}{365 \times 86400} $$
...
$$ \Huge total = principal \times closingRate $$
