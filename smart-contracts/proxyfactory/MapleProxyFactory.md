...
A Maple factory for Proxy contracts that proxy MapleProxied implementations.
...
### `defaultVersion` _\[state variable]_
...
### `mapleGlobals` _\[state variable]_
...
### `upgradeEnabledForPath` _\[state variable]_
